...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-extra-reflection", "1.0.1")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-extra-reflection")
        description.set("kotlin-extra-reflection")
        url.set("https://github.com/wabbit-corp/kotlin-extra-reflection")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-extra-reflection")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-extra-reflection.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-extra-reflection.git")
        }
    }
}
...
kover {
    ...
    //             // title.set("kotlin-extra-reflection Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-extra-reflection")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-extra-reflection/tree/master/src/main/kotlin")
